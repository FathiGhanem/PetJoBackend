...
class PetBase(BaseModel):
    ...
    city_id: Optional[int] = Field(None, gt=0, description="City ID (must be greater than 0)")
    category_id: Optional[int] = Field(None, gt=0, description="Category ID (must be greater than 0)")
